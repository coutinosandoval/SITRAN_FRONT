...
export class VehiculoComponent implements OnInit {
  ...
  guardar(): void {
    ...
    this.modalTitulo = this.modoEdicion ? 'Actualizar Vehículo' : 'Registrar Vehículo';
    ...
    this.modalAccion = () => {
      ...
      if (this.modoEdicion && this.vehiculoSeleccionado) {
        ...
        this.vehiculoService.agregar(datos).subscribe({
          next: () => {
            this.cargando = false;
            this.mensajeExito = 'Vehículo registrado correctamente.';
            this.volverLista();
            this.cargarVehiculos();
          },
          error: (err) => {
  ...
  eliminar(id: number): void {
    ...
    this.modalMensaje = '¿Está seguro que desea eliminar este vehículo?';
